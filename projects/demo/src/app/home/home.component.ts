...
export class HomeComponent implements OnInit {
  ...
  multiTypeChartData = [
    [{ x: -1, y: 25 }, { x: 6, y: 35 }, { x: 2, y: 30 }, { x: 3, y: 40 }, { x: 4, y: 30 }, { x: 5, y: 45 }],
    [{ x: -1, y: 20 }, { x: 6, y: 28 }, { x: 2, y: 24 }, { x: 3, y: 32 }, { x: 4, y: 24 }, { x: 5, y: 36 }],
    [{ x: -1, y: 15 }, { x: 6, y: 21 }, { x: 2, y: 18 }, { x: 3, y: 24 }, { x: 4, y: 18 }, { x: 5, y: 27 }],
